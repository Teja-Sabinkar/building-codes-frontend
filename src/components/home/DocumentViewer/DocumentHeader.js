...
// UPDATED: Now supports rightActions for recently viewed button
'use client';
...
export default function DocumentHeader({ 
  ...
  totalPages, 
  onClose,
  rightActions  // 🆕 NEW: Optional right-side actions (recently viewed button)
}) {
  return (
    <div className={styles.documentHeader}>
      ...
      <div className={styles.headerActions}>
        {/* Right actions (recently viewed button) */}
        {rightActions}
